...
class CarSeatsBookedController extends GetxController with SingleGetTickerProviderMixin {
  final count = 0.obs;
  ...
  void onInit() {
    ...
    if(Get.arguments != null){
      ...
      if(Get.arguments["selected_seat"] != null){
        strSelectedSeat = Get.arguments["selected_seat"];
      }
    }
