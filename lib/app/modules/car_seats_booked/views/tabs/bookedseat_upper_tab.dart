...
class BookedSeatUpperTab extends StatelessWidget {
          ...
          child: Stack(
            children: [
              ...
              Padding(padding: EdgeInsets.all(36), child:  GridView.count(
                ...
                children: List.generate(_carSeatsBookedController.upperList.length, (index) {
                  Map mapSeat = _carSeatsBookedController.upperList[index];
                  return Center(
                    child: Row(
