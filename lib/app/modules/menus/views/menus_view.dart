                   ...
                   children: [
                     ...
                     GetBuilder<MenusController>(
                       ...
                       child: Container(
                         ...
                         child: Row(
                           children: [
                             value.urlImage.isNotEmpty ? CircleAvatar(
                               backgroundColor: Colors.transparent,
                               radius: 28.0,
                               backgroundImage: NetworkImage("https://ridethebee-staging.vecapital.asia/storage/app/passengers/${value.urlImage}"),
                             ...
                             Expanded(child: Column(
                               ...
                               children: [
                                 ...
                                 SizedBox(height: 4),
                                 Text(value.email, style: TextStyle(
                                     fontSize: 12,
                                     fontFamily: "PoppinsMedium",
                                     color: Color.fromRGBO(63, 61, 86, 1.0)
                                 ))
                       ...
                       onTap: (){
                         Get.to(() => ProfileView())?.then((value) => _menusController.loadUser());
                       },
                     )),
